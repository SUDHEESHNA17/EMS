...
public class TaskAssign {
	...
	public TaskAssign(long taskId, @NotNull @NotEmpty(message = " Taskname should not be empty") String taskName,
			@NotNull @NotEmpty(message = "  description should not be empty") String description,
			@NotNull LocalDate dueDate, String taskStatus, String taskProgress, @NotNull String emailId,
			@NotNull String memailId) {
		super();
		this.taskId = taskId;
		this.taskName = taskName;
		this.description = description;
